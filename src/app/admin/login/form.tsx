...
export function AdminLoginForm() {
  ...
  return (
    <form action={action} className="space-y-3">
      <label className="block"><span className="label mb-1 block">Username</span><input name="username" type="text" required autoComplete="username" autoCapitalize="none" autoCorrect="off" spellCheck={false} className="field" /></label>
